#!/usr/bin/env python3
"""writ.ai PreToolUse hook — the enforcement point.

Reads the hook event on stdin, asks the writ.ai supervisor whether this session is
...
the service can read ``.writai/task`` itself — see ``writai_hook_lib``.)
"""
