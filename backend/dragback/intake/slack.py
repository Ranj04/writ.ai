...
from dragback.domain import Artifact
...
from dragback.llm.extractor import DecisionExtractor
from dragback.workspaces.models import WorkspaceProposalRequest
        ...
        *,
        ...
        try:
            ...
            raise SlackWebhookError(
                "Install Dragback with the 'composio' extra for live Slack intake."
            ) from exc
