...
from dragback.workspaces.models import WorkspaceExecutionResult
from dragback.workspaces.supervisor import SupervisorAssignmentState
...
def build_interrupt_escalation_plan(
    ...
    objective = _bounded(
        (
            "Notify the authorized lead that Dragback assignment "
    ...
    instructions = [
        ...
        (
            ...
            "Dragback; do not approve work or make commitments on the call."
        ),
    ]
    requirement_actions = [
        PlanAction(
    ...
    if (
        ...
        return _result(
            ...
            reason=(
                ...
                "Dragback refused to report a live escalation."
            ),
            verification_code=execution.verification_code,
            execution_mode=execution.execution_mode,
