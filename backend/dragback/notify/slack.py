    ...
    def live(
        ...
        *,
        ...
        try:
            ...
            raise SlackNotificationError(
                "Install Dragback with the 'composio' extra for live Slack delivery."
            ) from exc
...
def compose_slack_thread_message(
    *,
    ...
    lines = [
        "Dragback decision approval preview",
        ...
        *evidence_lines,
        ...
        (
            "A reaction is only an approval request. Dragback must resolve the "
