...
| DEMO-ENV-1 | **Resolved except `elliptic`** | 10 advisories became 4 low: `npm audit fix` plus a separate `pdfjs-dist` 6.3.289 upgrade closing a high-severity arbitrary-JS-on-malicious-PDF advisory this product reaches through document import. The 4 remaining have no patched version. |
